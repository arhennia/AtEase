...
export function TenantHeader({ partner }) {
  ...
  return (
    <header className="sticky top-0 w-full z-40">
      <div className="max-w-[1100px] mx-auto px-5 sm:px-8 pt-3 pb-2">
        <div className="glass-nav h-[60px] rounded-full px-4 sm:px-5 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="relative p-2.5 rounded-full text-[#1C1917] hover:bg-white/60 flex items-center gap-1.5 transition-colors"
